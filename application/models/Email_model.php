...
class Email_model extends CI_Model {
    ...
    function contact_us_email($email_msg = '', $email_sub = '', $from = '') {
        
        $this->send_email($email_msg, $email_sub,$from);
    }
    ...
    function do_email($msg = NULL, $sub = NULL, $to = NULL, $from = NULL) {
        ...
        $msg = $msg . "<br /><br /><br /><br /><br /><br /><br /><hr /><center>Admin</center>";
    ...
    function send_email($msg = NULL, $sub = NULL, $from = NULL, $name = NULL) {
