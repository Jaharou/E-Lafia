...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            ...
            <form method="post" action="<?php echo base_url(); ?>pharmacist/profile/update/<?php echo $row['pharmacist_id']; ?>" class="p-20" id="form-validate" enctype="multipart/form-data">               
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('image'); ?><img src="<?php echo $this->crud_model->get_image_url('pharmacist' , $pharmacist_id );?>" class="img-circle" width="20px" height="20px"></label>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            <div style="clear:both;"></div>                     
            <div class="panel-body p-20">
            <form method="post" action="<?php echo base_url(); ?>pharmacist/profile/change_password" class="p-20" id="form2-validate">             
