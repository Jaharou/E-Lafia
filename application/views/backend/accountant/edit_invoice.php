            ...
            <div class="panel panel-primary" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title" >
                        ...
                        <?php echo get_phrase('modifier la facture'); ?>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('titre de la facture'); ?></label>

                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="title" id="title" data-validate="required" 
                                   data-message-required="<?php echo get_phrase('valeur requise'); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="patient_id" class="select2">
                                <option><?php echo get_phrase('selectionner le patient'); ?></option>
                                <?php
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase("date d'échéance"); ?></label>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('pourcentage de tva'); ?></label>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('montant de la remise'); ?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="status" class="selectboxit">
                                <option><?php echo get_phrase('selectionner le statut'); ?></option>
                        ...
                        foreach ($invoice_entries as $invoice_entry) {
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">
                                    <?php echo get_phrase('facture_entrée'); ?></label>
                    ...
                    <div id="invoice_entry_temp">
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('facture_entrée'); ?></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-8">
                            <button type="button" class="btn btn-default btn-sm btn-icon icon-left"
                                    onClick="add_entry()">
                                        <?php echo get_phrase('ajouter une facture'); ?>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-8">
                            <button type="submit" class="btn btn-info" id="submit-button">
                                <?php echo get_phrase('mettre à jour la facture'); ?></button>
