...
?>
    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <form method="post" action="<?php echo base_url(); ?>accountant/profile/update/<?php echo $row['accountant_id']; ?>" class="p-20" id="form-validate" enctype="multipart/form-data">               
                    <h5 class="mt-n"><?php echo get_phrase('information de profil'); ?></h5>
                    <div class="row">
                        <div class="col-md-4">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('image'); ?><img src="<?php echo $this->crud_model->get_image_url('accountant' , $accountant_id );?>" class="img-circle" width="20px" height="20px"></label>
                        ...
                        <div class="col-md-4">
                            <div class="btn-group pull-right mt-10" role="group">
                                ...
                                <button type="submit" class="btn bg-black btn-wide"><i class="fa fa-arrow-right"></i>Mise à jour
</button>
                            </div>                
                        </div>
                     </div> 
...
<div class="row">
    <div class="col-md-12">
        <div class="panel">
            <div style="clear:both;"></div>                     
            <div class="panel-body p-20">
            <form method="post" action="<?php echo base_url(); ?>accountant/profile/change_password" class="p-20" id="form2-validate">             
