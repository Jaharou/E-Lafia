    ...
    <div id="invoice_print">
        <table width="100%" border="0">
            <tr>
                ...
                <td align="right">
                    <h4><?php echo get_phrase('numéro de facture'); ?> : <?php echo $row['invoice_number']; ?></h4>
                    <h5><?php echo get_phrase("date d'émission"); ?> : <?php echo $row['creation_timestamp']; ?></h5>
                    <h5><?php echo get_phrase("date d'échéance"); ?> : <?php echo $row['due_timestamp']; ?></h5>
                    <h5><?php echo get_phrase('statut'); ?> : <?php echo $row['status']; ?></h5>
                </td>
            </tr>
        </table>
        <hr>
        <table width="100%" border="0">    
            <tr>
                <td align="left"><h4><?php echo get_phrase('Paiement à'); ?> </h4></td>
                <td align="right"><h4><?php echo get_phrase('facturer'); ?> </h4></td>
            </tr>
        ...
        <hr>
        <h4><?php echo get_phrase('entrées de facture'); ?></h4>
        <table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
            <thead>
                <tr>
                    <th class="text-center">#</th>
                    <th width="60%"><?php echo get_phrase('saisie'); ?></th>
        ...
        <table width="100%" border="0">    
            <tr>
                <td align="right" width="80%"><?php echo get_phrase('sous-total'); ?> :</td>
                <td align="right"><?php echo $currency_symbol . $total_amount; ?></td>
            </tr>
            <tr>
                <td align="right" width="80%"><?php echo get_phrase('tva'); ?> :</td>
                <td align="right"><?php echo $row['vat_percentage']; ?>% </td>
            </tr>
            <tr>
                <td align="right" width="80%"><?php echo get_phrase('remise'); ?> :</td>
