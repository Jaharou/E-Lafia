...
<div class="row">
    <div class="col-md-12">
		<div class="panel">
			<a href="<?php echo base_url(); ?>nurse/patient_crud/add" class="btn bg-black btn-wide pull-right"> <i class="fa fa-paperclip"></i>
								...
								<?php foreach ($patient_info as $row): ?>   
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url(); ?>nurse/patient_crud/edit/<?php echo $row['patient_id']; ?>" class="btn btn-success btn-rounded icon-only">
												...
												<a class="btn btn-danger btn-rounded icon-only" href="#" onclick="confirm_modal('<?php echo base_url(); ?>nurse/patient/delete/<?php echo $row['patient_id']; ?>');">
