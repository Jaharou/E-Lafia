...
<button onclick="showAjaxModal('<?php echo base_url();?>modal/popup/add_report/');" 
    class="btn btn-primary pull-right">
        <?php echo get_phrase('ajouter un rapport'); ?>
</button>
                        ...
                        foreach ($report_info as $row) { ?>   
                            <tr>
                                ...
                                <td>
									...
									<a class="btn btn-danger btn-sm btn-icon icon-left" href="#" onclick="confirm_modal('<?php echo base_url(); ?>nurse/report/delete/<?php echo $row['report_id']; ?>');">
