                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name13" name="invoice_id"  data-validation="" value="<?php echo rand(10000, 100000); ?>" readonly >
                            </div>
                        </div>  
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase('date_de_creation'); ?><sup class="color-danger">*</sup></label>
                                <input type="datetime-local" class="form-control" id="name13" name="creation_timestamp"  data-validation="required" value="<?php echo gmdate("d m Y h:i:s"); ?>" >
                            </div>
                        </div>
                <div class="col-md-3">
                        <div class="form-group">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="name13"><?php echo get_phrase('prestation'); ?><sup class="color-danger">*</sup></label>
            <select name="entry_description[]" class=" form-control select2" id="js-states">
        <optgroup>
            <option>Sélectionner une prestation</option><?php
           ...
           <option value="<?php echo $row2['libelle']; ?>">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="entry_amount" name="entry_amount[]" data-validation="required">
                </div>
            </div>                   
        ...
        <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name13"><?php echo get_phrase("note"); ?><sup class="color-danger"></sup></label>
                                <input type="text" class="form-control" id="note" name="note"  data-validation="" size="30">
                            </div>
                        </div>
                     </div> 
...
remiseInput.addEventListener("input", calculerMontantNet);
...
function calculerMontantNet() {
  ...
  var remise = parseFloat(remiseInput.value);
  var prise = parseFloat(priseInput.value);

  // Calculer le montant net
  var montantNet = montant - (montant * remise / 100) - (montant * prise / 100);
