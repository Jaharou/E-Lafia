        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <!--<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="patient_id" class="js-states form-control select2" id="js-states">
                                ...
                                $invoice = $this->db->get('patient')->result_array();
                                  foreach ($invoice as $row2):
                                    ?>
                                    <option value="</?php echo $row2['patient_id']; ?>"
                                      </?php if ($row2['patient_id'] == $row2['patient_id']) echo 'selected'; ?> >
                                   </?php echo $row2['name']; ?>
                                    </option>
                                </?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('prise-en-charge'); ?></label>
                        <div class="col-sm-5">
                            <div class="input-group">
                            <span class="input-group-addon"><i class="entypo-info-circled"></i></span>
                                <input type="text" class="form-control" name="prise_en_charge"  
                                value="<?php echo $row['prise_en_charge']; ?>" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('mode-de-paiement'); ?></label>
                              <div class="col-sm-5">
                                <select name="mode_paiement" class="js-states form-control" id="js-states">
                                    <optgroup>
                                        <option>-</option>
