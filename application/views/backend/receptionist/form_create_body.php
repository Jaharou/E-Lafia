        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="type" class="form-control" id="element_type">
                    <option value="text"><?php echo get_phrase('texte'); ?></option>
                    <option value="textarea"><?php echo get_phrase('sujet'); ?></option>
                </select>
            </div>
            ...
            <div class="col-sm-3">
                <button type="button" class="btn btn-default btn-sm btn-icon icon-left"
                        onClick="add_entry()">
                            <?php echo get_phrase('ajouter un élément de formulaire'); ?>
...
<script>
    ...
    function add_entry()
    {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?receptionist/get_form_element/' + element_type,
